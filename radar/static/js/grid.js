...
grid.drawgrid = {
    ...
    GridBottom: function (p_x,sc_x) {
        console.log("grid ehehey")
            ...
            for(i=0; i<quan_step_scale_GRID_X_left;i++){
                ...
                if(txt!='none'){
                    text = new fabric.Text(txt, { left: x, top: y+3, fontSize: 10, originX: 'center', evented: false, selectable: false});
    ...
    GridLeft: function (p_y,sc_y) {
        ...
        for(i=0; i<quan_step_scale_GRID_Y_top;i++){
            ...
            if(txt!='none'){
                text = new fabric.Text(txt, { left: x-3, top: y, fontSize: 10, originX: 'right', originY: 'center', evented: false, selectable: false});
